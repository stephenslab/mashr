...
from the random tests and use `estimate_null_correlation` as in [this vignette](intro_correlations).
```{r}
data.temp = mash_set_data(simdata$Bhat[random.subset,],
                          simdata$Shat[random.subset,])
