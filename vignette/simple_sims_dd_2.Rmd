...
```{r}
  m.1by1 = mash_run_1by1(data$Bhat, data$Shat)
  ...
  m.1 = mash(data$Bhat,data$Shat, U1)
  m.2 = mash(data$Bhat,data$Shat, U2)
  m.3 = mash(data$Bhat,data$Shat, c(U1,U2))
  m.4 = mash(data$Bhat,data$Shat, Utrue)
  m.5 = mash(data$Bhat,data$Shat, c(Utrue,U1,U2))
  m.1$loglik
  m.2$loglik
  m.3$loglik
  m.4$loglik
