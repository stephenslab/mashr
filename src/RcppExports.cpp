...
// calc_sermix_rcpp
Rcpp::List calc_sermix_rcpp(Rcpp::NumericMatrix b_mat, Rcpp::NumericMatrix s_mat, Rcpp::NumericMatrix s_alpha_mat, Rcpp::NumericMatrix s_orig_mat, Rcpp::NumericMatrix v_mat, Rcpp::NumericVector U_3d, Rcpp::NumericVector Uinv_3d, Rcpp::NumericVector vinv_3d, Rcpp::NumericVector U0_3d, Rcpp::NumericMatrix posterior_mixture_weights, Rcpp::NumericMatrix posterior_variable_weights, bool common_cov);
RcppExport SEXP _mashr_calc_sermix_rcpp(SEXP b_matSEXP, SEXP s_matSEXP, SEXP s_alpha_matSEXP, SEXP s_orig_matSEXP, SEXP v_matSEXP, SEXP U_3dSEXP, SEXP Uinv_3dSEXP, SEXP vinv_3dSEXP, SEXP U0_3dSEXP, SEXP posterior_mixture_weightsSEXP, SEXP posterior_variable_weightsSEXP, SEXP common_covSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type b_mat(b_matSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type common_cov(common_covSEXP);
    rcpp_result_gen = Rcpp::wrap(calc_sermix_rcpp(b_mat, s_mat, s_alpha_mat, s_orig_mat, v_mat, U_3d, Uinv_3d, vinv_3d, U0_3d, posterior_mixture_weights, posterior_variable_weights, common_cov));
    return rcpp_result_gen;
END_RCPP
}
