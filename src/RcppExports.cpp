...
// calc_lik_rcpp
Rcpp::List calc_lik_rcpp(Rcpp::NumericMatrix b_mat, Rcpp::NumericMatrix s_mat,
	Rcpp::NumericMatrix v_mat, Rcpp::NumericVector U_3d, bool logd);

RcppExport SEXP mashr_calc_lik_rcpp(SEXP b_matSEXP, SEXP s_matSEXP, SEXP v_matSEXP, SEXP U_3dSEXP,
                                    SEXP logdSEXP)
{
	BEGIN_RCPP
...
// calc_post_rcpp
Rcpp::List calc_post_rcpp(Rcpp::NumericMatrix b_mat, Rcpp::NumericMatrix s_mat,
	Rcpp::NumericMatrix v_mat, Rcpp::NumericVector U_3d,
	Rcpp::NumericMatrix posterior_weights);

RcppExport SEXP mashr_calc_post_rcpp(SEXP b_matSEXP, SEXP s_matSEXP, SEXP v_matSEXP, SEXP U_3dSEXP,
                                     SEXP posterior_weightsSEXP)
{
	BEGIN_RCPP
	Rcpp::RObject rcpp_result_gen;
	Rcpp::RNGScope rcpp_rngScope_gen;
