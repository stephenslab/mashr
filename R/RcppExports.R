...
calc_sermix_rcpp <- function(b_mat, s_mat, v_mat, vinv_3d, U_3d, Uinv_3d, U0_3d, posterior_mixture_weights, posterior_variable_weights, sigma0, common_cov) {
    .Call('_mashr_calc_sermix_rcpp', PACKAGE = 'mashr', b_mat, s_mat, v_mat, vinv_3d, U_3d, Uinv_3d, U0_3d, posterior_mixture_weights, posterior_variable_weights, sigma0, common_cov)
}
