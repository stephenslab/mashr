...
calc_post_precision_rcpp <- function(b_mat, s_mat, s_alpha_mat, s_orig_mat, v_mat, l_mat, a_mat, vinv_mat, U0_3d, posterior_weights, report_type) {
    .Call('_mashr_calc_post_precision_rcpp', PACKAGE = 'mashr', b_mat, s_mat, s_alpha_mat, s_orig_mat, v_mat, l_mat, a_mat, vinv_mat, U0_3d, posterior_weights, report_type)
}
